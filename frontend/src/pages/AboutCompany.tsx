...
const AboutCompany: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="About Kidist - Fertility & Wellness Expert"
        description="Meet Kidist, your fertility and wellness coach. Expert guidance for PCOS, hormone balance, and natural conception strategies with science-backed protocols."
        keywords="Kidist, fertility coach, wellness expert, PCOS support, hormone balance, natural conception, fertility journey, women health"
        image="/og-about.jpg"
        ...
        structuredData={{
          ...
          '@type': 'Person',
          name: 'Kidist Moges',
          jobTitle: 'Fertility & Wellness Coach',
          description: 'Expert fertility and wellness coach specializing in PCOS, hormone balance, and natural conception strategies',
          url: window.location.href,
          sameAs: [
            'https://www.instagram.com/kidumoges/',
            'https://www.facebook.com/kidist.moges.9/',
            'https://www.youtube.com/channel/UCHlZD122AwI1Gmc-sFWEY8A',
            'https://www.tiktok.com/@kiduen',
            'https://t.me/faithtoconveive'
          ],
          knowsAbout: ['Fertility', 'PCOS', 'Hormone Balance', 'Natural Conception', 'Women Health']
        }}
      />
          ...
          <div className="container grid-2" style={{ alignItems: 'center', gap: '4rem' }}>
            ...
            <div className="animate-fade-in-right" style={{ display: 'flex', justifyContent: 'center' }}>
              <div style={profileCardStyle}>
                ...
                <img
                  src="https://p16-common-sign.tiktokcdn.com/tos-maliva-avt-0068/f4e9cd42f22ac626004332a37464cd61~tplv-tiktokx-cropcenter:1080:1080.jpeg?dr=14579&refresh_token=c73b469d&x-expires=1782079200&x-signature=2MPLUO2vSt9qWUfV1iRkvdVnTZc%3D&t=4d5b0474&ps=13740610&shp=a5d48078&shcp=81f88b70&idc=my3"
